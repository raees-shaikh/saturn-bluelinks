    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            <div class="row page-titles ">
                ...
                <div class="">
                    @if (!$dataCount)
                        <a href="{{ route('cms.data.create') }}" class="btn btn-info">
                        ...
                        @forelse ($datas as $data)
                            <tr>
                                ...
                                <td class="btns-row-style">
                                    <a href="{{ route('cms.data.edit', $data->id) }}" class="btn btn-info mx-2">Edit
                                    </a>
                                    <a class="btn btn-danger " href="{{ route('cms.data.delete', $data->id) }}"
