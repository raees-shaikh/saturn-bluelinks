        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Edit Offer</h4>
                </div>
                            ...
                            <div class="col-sm-12 col-xs-12 p-0">
                                <form id="form" action="{{ route('cms.offer.update', $offer->id) }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="{{ old('url', $offer->yt_url) }}" type="text"
                                            id="url" name="url" maxlength="60" minlength="3" placeholder="Enter Url" >
                                    </div>
                                    @if ($errors->has('url'))
                                        <div class="alert alert-danger">
