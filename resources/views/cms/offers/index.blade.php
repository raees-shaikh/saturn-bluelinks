    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            <div class="row page-titles ">
                ...
                <div class="">
                    <a href="{{ route('cms.offer.create') }}" class="btn btn-info">
                        ...
                        @forelse ($offers as $offer)
                            <tr>
                                ...
                                <td class="d-flex-on-mobi">
                                    <a href="{{ route('cms.offer.show', $offer->id) }}" class="btn btn-info">View
                                    </a>
                                    <a href="{{ route('cms.offer.edit', $offer->id) }}" class="btn btn-info mx-1">Edit
                                    </a>
                                    <a onclick="return confirm('Are you sure you want delete this Latest Offer?');"
                                        class="btn btn-danger" href="{{ route('cms.offer.delete', $offer->id) }}">
                                        Delete
                                    </a>
                                </td>
                            </tr>
