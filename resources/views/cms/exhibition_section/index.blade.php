    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            <div class="row page-titles ">
                ...
                <div class="">
                    <a href="{{ route('cms.exhibition.media.create', $exhibitions->id) }}" class="btn btn-info">
                        ...
                        @forelse ($medias as $media)
                            <tr>
                                ...
                                <td class="img-on-tab-style">
                                    @if ($media->filename)
                                        <img src="{{ asset('storage/images/exhibition/' . $media->filename) }}" width="150px"
                                            height="150px">
                                    @endif
                                </td>
                                <td class="exhibition-action-style">
                                    <a href="{{ route('cms.exhibition.media.edit', ['exhibition_id' => $exhibitions->id, 'media_id' => $media->id]) }}"
                                        class="btn btn-info mr-2">Edit
                                    </a>
                                    <button onclick="return confirm('Are you sure you want delete this Media?');"
                                        type="submit" class="btn btn-danger mr-4">
                                        <a
