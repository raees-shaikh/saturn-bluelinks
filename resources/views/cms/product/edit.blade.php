                            ...
                            <div class="col-sm-12 col-xs-12 p-0">
                                ...
                                <form id="form" action="{{ route('cms.product.update', $product->id) }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="{{ old('url') ?? $product->yt_url }}"
                                            type="text" id="url" name="url" maxlength="60" minlength="3"
                                        ...
                                        <div class="col-12">
                                            <div class="card">
                                                <div class="card-body p-0">
                                                    <textarea placeholder="enter the description" id="mymce" name="body" minlength="3" maxlength="18000">{{ old('body') ?? $product->body }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        @if ($errors->has('body'))
