    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Edit Exhibition</h4>
            </div>
                        ...
                        <div class="col-sm-12 col-xs-12 p-0">
                            <form id="form" action="{{route('cms.exhibition.update',$exhibition->id)}}" method="POST" enctype="multipart/form-data" onSubmit="return confirm('Are you sure you want to submit?');">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="date" id="date" name="start_date" value="{{old('start_date') ?? dd_format($exhibition->start_date,'Y-m-d')}}" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="date" id="date" name="end_date" value="{{old('date') ??  dd_format($exhibition->end_date, 'Y-m-d')}}" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" value="{{old('url',$exhibition->yt_url)}}" placeholder="Enter Url" id="title" name="url" maxlength="60" minlength="3">
                                </div>
                                @if ($errors->has('url'))
                                    <div class="alert alert-danger">
                                ...
                                <div class="form-group col-md-3">
                                    <button type="submit" id="check"
                                        class="site-buton btn btn-success waves-effect waves-light m-r-12  col-sm-12">Submit</button>
                                </div>
                            </form>
                        </div>
