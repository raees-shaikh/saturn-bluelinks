    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Create Exhibition</h4>
            </div>
                        ...
                        <div class="col-sm-12 col-xs-12 p-0">
                            <form id="form" action="{{route('cms.exhibition.store')}}" method="POST" enctype="multipart/form-data" onSubmit="return confirm('Are you sure you want to submit?');">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="url" name="url" placeholder="Enter Url" value="{{old('url')}}" maxlength="60" minlength="3" >
                                </div>
                                @if ($errors->has('url'))
                                    <div class="alert alert-danger">
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body p-0">
                                                <textarea  placeholder ="enter the description" id="mymce" name="descriptions" minlength="3" maxlength="18000">{{old('body')}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    @if ($errors->has('body'))
