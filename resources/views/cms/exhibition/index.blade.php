    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            <div class="row page-titles ">
                ...
                <div class="">
                    <a href="{{ route('cms.exhibition.create') }}" class="btn btn-info">
                        ...
                        @forelse ($exhibitions as $exhibition)
                            <tr>
                                ...
                                <td class="btns-row-style">
                                    <a href="{{ route('cms.exhibition.show', $exhibition->id) }}" class="btn btn-info">View
                                    </a>
                                    <a href="{{ route('cms.exhibition.edit', $exhibition->id) }}" class="btn btn-info mx-2">Edit
                                    </a>
                                    ...
                                    <a onclick="return confirm('Are you sure you want delete this Exhibition?');"
                                        class="btn btn-danger mr-1" href="{{ route('cms.exhibition.delete', $exhibition->id) }}">
                                        Delete
                                    </a>
                                </td>
                            </tr>
