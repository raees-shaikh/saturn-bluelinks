                    ...
                    <div class="card card-body col-lg-6 py-0 pt-2">
                        <div class="row">
                            <div class="col-sm-12 col-xs-12 p-0">
                                <form id="form" action="{{ route('cms.categories.update', $categories->id) }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text"
                                            ...
                                            id="title" name="title" maxlength="60" minlength="3" required>
                                    </div>
                                    @if ($errors->has('title'))
...
{{--
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text"
                                            value="{{ old('title', $categories->yt_url) }}" placeholder="Enter Url"
                                            id="title" name="url" maxlength="60" minlength="3">
                                        @if ($errors->has('url'))
                                            <div class="alert alert-danger">
