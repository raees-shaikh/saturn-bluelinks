    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            <div class="row page-titles ">
                ...
                <div class="">
                    <a href="{{ route('cms.categories.create') }}" class="btn btn-info">
                        ...
                        @forelse ($categories as $categorie)
                            <tr>
                                ...
                                <td class="btns-row-style">
                                    <a href="{{ route('cms.categories.show', $categorie->id) }}" class="btn btn-info">View
                                    </a>
                                    <a href="{{ route('cms.categories.edit', $categorie->id) }}" class="btn btn-info mx-2">Edit
                                    </a>
                                    <a class="btn btn-danger " href="{{ route('cms.categories.delete', $categorie->id) }}"
