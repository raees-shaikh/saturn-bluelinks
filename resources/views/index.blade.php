...
@section('content')
                            ...
                            <div id="rev_slider_home" class="rev_slider fullscreenbanner tiny_bullet_slider"
                                ...
                                <ul>
                                    ...
                                    <li data-index="rs-1" data-transition="fade" data-slotamount="default"
                                        ...
                                        <!-- MAIN IMAGE -->
                                        <img src="images/banner/au.png" alt="" data-bgposition="center center"
                            ...
                            <div id="rev_slider_home-mob" class="rev_slider fullscreenbanner tiny_bullet_slider"
                                ...
                                <ul>
                                    ...
                                    <li data-index="rs-1-m" data-transition="fade" data-slotamount="default"
                                        ...
                                        data-saveperformance="off" data-title="Slide">
                                        <!-- MAIN IMAGE -->
                                        <img src="images/banner/au-m.png" alt="" data-bgposition="center center"
                                            data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="on"
                                            class=" rev-slidebg">
                                        <!-- LAYERS -->
                                    </li>
                ...
                <div class="logo-slider owl-carousel">
                    @foreach ($logos as $logo)
                        <a href="{{ $logo['img-path'] }}" target="_blank">
                            <img src="{{ $logo['img-path'] }}" width="100" class="mt-2 h-80 m-full"
                                alt="{{ $logo['alt'] }}">
                        </a>
                    @endforeach
                </div>
                ...
                <div class="container">
                    <div class="section-content">
                        <div class="row justify-content-center d-flex">
                            <div class="col-lg-6 col-md-12 m-b30 mt-lg-5 mt-0">
                            ...
                            <div class="col-lg-6 col-md-12 m-b30">
                                <div class="about-section-three-right">
                                    <!-- TITLE START-->
                                    <div class="left wt-small-separator-outer text-lg-start text-center">
                                    ...
                                    <p class="p-1 m-0"> Saturn Blue Links Oldest & trusted Indian company, a part of HR group of companies,  Saturn Blue Links are Largest International Brokers & Agents For
                                        New Complete Plants
                                    ...
                                    <div class="ab-three-info d-lg-flex justify-content-between text-lg-start text-center">
    ...
    <section>
        ...
        @php
            ...
            $MANUFACTURERS = [
                ...
                [
                    'name' => 'ANDRTIZ',
                    'link' =>
                        'https://www.andritz.com/products-en/group/nonwoven-textile/needlepunch/excelle-range/specialty-needlelooms',
                ],
                [
                    'name' => 'FERHER',
                    'link' => '#',
        ...
        <div class="container ">
            ...
            <p class="text-center mx-auto mt-4 ">Best European, Japanese Manufacturer's Quality  Machineries & Low
                Costs From Who's Who In Techncial Textile Industry OEM</p>
            <div class="row pb-5">
                @foreach ($MANUFACTURERS as $item)
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12  mt-4 text-center">
    ...
    @if ($data)
        <div class="container ">
            ...
            <div class="row justify-content-center my-3">
                <a target="_blank" href="{{ asset('storage/data/' . $data->filename) }}"
