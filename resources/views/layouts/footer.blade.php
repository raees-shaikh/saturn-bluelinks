                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="widget widget_about">
                        ...
                        <p>
                            ...
                            Are Largest International Brokers & Agents For New Complete Plants
                            & Machinery For Technical Textiles & Technical Engineered Plastics From Different Countries
                            Worldwide.
                        </p>
                    </div>

                    <div class="widget recent-posts-entry d-sm-block d-none">
                        <ul class="widget_address d-flex ">
                            <li><a href="{{ url('https://www.facebook.com/profile.php?id=100093698222653 ') }}"
                                    class="p-2" target="_blank"> <i class="fa fa-facebook"></i></a></li>
                            {{-- <li><a href="#" class="p-2"> <i class="fa fa-twitter"></i></a></li> --}}
                            <li><a href="{{ url('https://www.youtube.com/@saturnbluelinks') }}" class="px-3 py-2"
                                    target="_blank"> <i class="fa fa-youtube-play"></i></a></li>
                            <li><a href="{{ url('https://www.linkedin.com/in/saturn-bluelinks-110b08260') }}"
                                    class="p-2" target="_blank"> <i class="fa fa-linkedin"></i></a></li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="widget widget_newsletter">
                        ...
                        <div class="widget recent-posts-entry">
                            <ul class="widget_address mt-ul--6">
                                ...
                                <li><i class="fa fa-envelope"></i><a href="mailto:sales@saturnbluelinks.com">
                                        sales[at]saturnbluelinks[dot]com
                                    </a>
                                </li>
                                ...
                                <li>
                                    <i class="fa fa-map-marker"></i>South Carolina, USA
                                    <!-- <li style="margin-top: -10px">1363-1385 Sunset Blvd, Los Angeles, CA 90026, USA.</li>-->

                                </li>
                                <li>
                                    <i class="fa fa-map-marker"></i>Jebel Ali, UAE
                                    <!-- <li style="margin-top: -10px">1363-1385 Sunset Blvd, Los Angeles, CA 90026, USA.</li>-->

                                </li>
                                <li>
                                    <i class="fa fa-map-marker"></i>Guangzhuo, China
                                    <!-- <li style="margin-top: -10px">1363-1385 Sunset Blvd, Los Angeles, CA 90026, USA.</li>-->
                            ...
                            <div class="widget mb-30 recent-posts-entry d-sm-none d-block mt-3 text-center">
                                <ul class="widget_address d-flex text-center mx-auto">
                                    <li><a href="{{ url('https://www.facebook.com/profile.php?id=100093698222653 ') }}"
                                            class="p-2" target="_blank"> <i class="fa fa-facebook"></i></a></li>
                                    {{-- <li><a href="#" class="p-2"> <i class="fa fa-twitter"></i></a></li> --}}
                                    <li><a href="{{ url('https://www.youtube.com/@saturnbluelinks') }}" class="p-3"
                                            target="_blank"> <i class="fa fa-youtube-play"></i></a></li>
                                    <li><a href="{{ url('https://www.linkedin.com/in/saturn-bluelinks-110b08260') }}"
                                            class="p-2" target="_blank"> <i class="fa fa-linkedin"></i></a></li>
                                </ul>
        ...
        <div class="container">
            <div class="wt-footer-bot-left d-flex justify-content-center">
                ...
                <span class="copyrights-text">
                    ...
                    <a href="https://www.acetrot.com/" target="_blank" class="text-primary">Acetrot</a>.
