...
@section('content')
    ...
    <div class="section-full pt-4 pt-0 p-b30 bg-no-repeat bg-center bg-white">
        <div class="about-section-three">
            <div class="container">
                <div class="section-content">
                    <div class="row justify-content-center d-flex">

                        <div class="col-lg-6 col-md-12 m-b30  mt-0">
                                ...
                                <div class="about-three">
                                    <div class="about-year">
                                        <div class="about-year-info">
                                            ...
                                            <h3 class="wt-tilte">Running Business Since 1989</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-12 m-b30 ">
                            <div class="about-section-three-right">
                                <!-- TITLE START-->
                                <div class="left wt-small-separator-outer text-lg-left text-center">
                                ...
                                <p class="p-1 m-0">Saturn Blue Links Oldest & trusted Indian company, a part of HR group of companies, Saturn Blue Links are Largest International Brokers & Agents For New Complete Plants
                                    & Machinery For Technical Textiles & Technical Engineered Plastics From Different
                                    Countries
                                    Worldwide & specialise in TECHNICAL & MMF TEXTILE INDUSTRY.</p>
                                <p class="p-1 m-0">
                                    We offer a wide selection of canceled orders and brand-new and plants for the
                                    global polymer and plastics industry, including technical textiles.
                                </p>
                                <p class="p-1 m-0">
                                    We specialize in providing geotechnical and technical plastics industry plant and
                                    machinery solutions realted to all Polymers & Reinforced Materials. <br>
                                    THERMOPLASTICS | THERMOSETS | ELASTOMERS | LLDPE | LDPE | HDPE | POLYPROPYELENE |
                                    POLYESTER | NYLON | NYLON66 | POLYCARBONATE | PVA | UPVC | PVC | RUBBER | SYTHETIC
                                    RUBBER | CARBON | GLASS | ABS | ACRYCLIC | EPOXY | RESINS | NATURAL FIBERS | VISCOSE
                                    | COTTON | JUTE | BAMBOO FIBER & many many more.
                                </p>
                                <p class="p-1 m-0">
                                    We cater to various industries such as GEOCELL | GEOMEMBRANE | GEOSTRAPS | GEOGRIDS
                                    | FLAT WOVEN | WARP KNITTED WEFT INSERTIONS | EXTRUDED| BLOWN | CAST | BOPP | BOPET
                                    | BOPA | PVA FILMS | RUBBER SYNTH | RENIFRICED BY CARBON | GLASS | STEEL WIRE |
                                    ALUMINIUM WIRE | NON FEROUS & many more.
                                </p>
                        ...
                        <div class="col-12 m-b30">
                            <p class="p-1 m-0">Saturn Blue links has experience of more than three decades &
                                ...
                                plants &
                                having sold many  machinery, of which few are listed below:</p>
                            ...
                            <p class="p-1 m-0">Applications :
                                INFRAPROJECTS LIKE ROADS | RAILWAYS | TUNNELS | AEROSPACE | DEFENCE | PLASTICS
                                RECYLCING | EXTRUSIONS | ENGIENERING PLASTICS | PACKTECH | SPORTECH | INDUTECH |
                                MEDITECH | AGROTECH | COMPRESSED BIOGAS | ACQUACULURE | PONDS | FISHERES | WATER
                                STROAGES | METHANE GAS STORAGE | FILMS | COATING | EMBOSSING | REINFORCMENTS |
                                TARAPAULINS | VENTILATOR | DRY FILTERATION | WET FILTERATIONS | NONWOVENS NEEDLE
                                PUNCHED | SPUNBONDED | THERMOBONDED | CHEMCIAL BONDED | SPUN LACE | MAN MADE FIBER &
                                YARNS | TYRECORD | CONYVER BELTS | PHARAMA | TEXTILES | CEMENT | STEEL |
                                CONSTRCUTION | PROCESS CHEMICAL INDUSTRY | CONSUMER & FOOD PACKING | INDUSTRAIL
                                PACKING | COSMETICS & OIL PACAKING | LARGE DIAMETER PIPES TO SMALL | TANKS | BOARDS
                                | SHEETS.
                            </p>
                        </div>
        ...
        <div class="section-full p-t30 p-b30">
            <div class="container">
                ...
                <div class=" center wt-small-separator-outer text-center">
                    ...
                    <h2> Technical Textile Clients </h2>
                </div>
                <!-- TITLE END-->
                <div class="logo-slider owl-carousel">
                    @foreach ($logos as $logo)
                        <a href="{{ $logo['img-path'] }}" target="_blank">
                            <img src="{{ $logo['img-path'] }}" width="100" class="mt-2 h-80" alt="{{ $logo['alt'] }}">
                        </a>
                    @endforeach
